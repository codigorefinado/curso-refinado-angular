...
var Rule = (function (_super) {
    ...
    Rule.prototype.isEnabled = function () {
        return _super.prototype.isEnabled.call(this) && this.getOptions().ruleArguments.length > 0;
    };
...
var NoRequireFullLibraryWalker = (function (_super) {
    ...
    NoRequireFullLibraryWalker.prototype.reportFailure = function (node) {
        this.addFailureAt(node.getStart() + 1, // take quotes into account
        node.getWidth() - 2, Rule.FAILURE_STRING);
    };
