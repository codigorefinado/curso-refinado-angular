...
var NoUnusedVariablesWalker = (function (_super) {
    ...
    NoUnusedVariablesWalker.prototype.visitSourceFile = function (node) {
        ...
        if (this.possibleFailures.some(function (f) { return f.hasFix(); })) {
            var newText = Lint.Fix.applyAll(this.getSourceFile().getFullText(), this.possibleFailures.map(function (f) { return f.getFix(); }).filter(function (f) { return !!f; }));
        ...
        this.possibleFailures.forEach(function (f) {
            if (!someFixBrokeIt || !f.hasFix()) {
                ...
                var newText = f.getFix().apply(_this.getSourceFile().getFullText());
